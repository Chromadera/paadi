...
export const OnboardingPhoneScreen: React.FC = () => {
  ...
  function handleSendCode() {
    ...
    signupStart.mutate(fullPhone, {
      onSuccess: () => navigation.navigate('OnboardingOTP'),
      onError: (err: Error) => setErrorMsg(err.message || 'Failed to send code. Try again.'),
    });
  }

  const isPending = signupStart.isPending;
