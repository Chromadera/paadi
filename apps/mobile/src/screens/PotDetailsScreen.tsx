...
export const PotDetailsScreen: React.FC = () => {
  ...
  const isSettled = apiPot.status === 'settled';
      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scroll}>
        ...
        <View style={styles.summary}>
          ...
          <View style={styles.statusPill}>
            ...
            <Text style={styles.statusText}>{isSettled ? 'Completed' : 'Active'}</Text>
          </View>
        </View>
        ...
        <View style={styles.sectionWrap}>
          <View style={styles.brutCard}>
            <View style={styles.metaRow}>
              <Text style={styles.metaLabel}>{isSettled ? 'Ended On' : 'Due Date'}</Text>
              ...
              <View key={member.avatarIndex} style={[styles.memberRow, i < members.length - 1 && styles.memberRowBorder]}>
                ...
                <View style={styles.memberInfo}>
                  ...
                  <Text style={styles.memberSubtitle}>
                    {member.paid ? `Paid ₦${member.amount.toLocaleString()}` : `Owes ₦${member.amount.toLocaleString()}`}
                  </Text>
                </View>
        ...
        <View style={styles.actions}>
          {!isSettled && (
            <Button title="Remind Pending" onPress={() => {}} />
          )}
          <Pressable
            style={[styles.payoutBtn, !isSettled && styles.payoutBtnMargin]}
            onPress={() => navigation.navigate('PotAddBankPayout', { potId })}
          >
            <Text style={styles.payoutBtnText}>Payout to Bank</Text>
          </Pressable>
        </View>
      </ScrollView>
    </SafeAreaView>
...
const styles = StyleSheet.create({
  ...
  // Section wrapper (pad 0 4px)
  sectionWrap: {
    paddingHorizontal: spacing['1'],
    marginTop: spacing['4'],
  },

  // Brutalist card (meta + members list)
  brutCard: {
    borderWidth: 2,
  ...
  // Brutalist card list variant (overflow hidden for dividers)
  brutCardList: {
    borderWidth: 2,
    borderColor: colors.fg,
    borderRadius: radius.md,
